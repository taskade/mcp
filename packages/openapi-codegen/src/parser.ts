...
import { convertOpenApiSchemaToJsonSchema, isOperation, isParameterObject, isRequestBodyObject, getResponseObject } from './openapi';
...
export const parseOpenApi = (paths: OpenAPIV3_1.PathsObject | OpenAPIV3.PathsObject | OpenAPIV2.PathsObject): ParsedTool[] => {
