...
var setupTools = (server) => {
  ...
  server.tool(
    ...
    "Update task.",
    external_exports.object({
      contentType: external_exports.enum(["text/markdown", "text/plain"]).optional(),
      content: external_exports.string().regex(new RegExp("^[^\\r\\n]*$")).max(2e3).optional(),
      projectId: external_exports.string(),
    ...
    external_exports.object({
      tasks: external_exports.array(
        external_exports.intersection(
          external_exports.object({
            contentType: external_exports.enum(["text/markdown", "text/plain"]),
            content: external_exports.string().max(2e3)
          }),
          external_exports.union([
            external_exports.object({
              taskId: external_exports.literal("null").optional(),
              placement: external_exports.enum(["afterbegin", "beforeend"])
            }).strict(),
            external_exports.object({
              taskId: external_exports.string(),
  ...
  server.tool(
    ...
    "Task assignment",
    external_exports.object({
      handles: external_exports.array(external_exports.string().min(1)).optional(),
      projectId: external_exports.string(),
      taskId: external_exports.string()
    }).shape,
    async (args) => {
  ...
  server.tool(
    ...
    external_exports.object({
      type: external_exports.enum(["text/plain", "text/markdown"]).optional(),
      value: external_exports.string().regex(new RegExp("^[^\\r\\n]*$")).min(1).optional(),
      projectId: external_exports.string(),
      taskId: external_exports.string()
    }).shape,
    async (args) => {
